...
//
//  GTLSpectrumPawsVerifyDeviceResponse.m
//
...
@implementation GTLSpectrumPawsVerifyDeviceResponse
@dynamic databaseChange, deviceValidities, kind, type, version;

+ (NSDictionary *)arrayPropertyToClassMap {
  NSDictionary *map =
    [NSDictionary dictionaryWithObject:[GTLSpectrumDeviceValidity class]
                                forKey:@"deviceValidities"];
  return map;
}

+ (void)load {
  [self registerObjectClassForKind:@"spectrum#pawsVerifyDeviceResponse"];
}
