...
//
//  GTLSpectrumPawsGetSpectrumResponse.m
//
...
@implementation GTLSpectrumPawsGetSpectrumResponse
...
+ (NSDictionary *)arrayPropertyToClassMap {
  NSDictionary *map =
    [NSDictionary dictionaryWithObject:[GTLSpectrumSchedule class]
                                forKey:@"spectrumSchedules"];
  return map;
}

+ (void)load {
  [self registerObjectClassForKind:@"spectrum#pawsGetSpectrumResponse"];
}
