...
// these flags do. Acceptable values are: character_set_server utf8 or utf8mb4
// event_scheduler on or off (Note: The event scheduler will only work reliably
// if the instance activationPolicy is set to ALWAYS) general_log on or off
// group_concat_max_len 4..17179869184 innodb_flush_log_at_trx_commit 0..2
// innodb_lock_wait_timeout 1..1073741824 log_bin_trust_function_creators on or
// off log_output Can be either TABLE or NONE, FILE is not supported
// log_queries_not_using_indexes on or off long_query_time 0..30000000
// lower_case_table_names 0..2 max_allowed_packet 16384..1073741824 read_only on
// or off skip_show_database on or off slow_query_log on or off. If set to on,
// you must also set the log_output flag to TABLE to receive logs. wait_timeout
// 1..31536000
