...
@property (retain) NSArray *fare;  // of GTLQPXExpressFareInfo
...
@property (copy) NSString *fareCalculation;
...
@property (copy) NSString *saleFareTotal;

// The taxes in the sale or equivalent currency.
@property (copy) NSString *saleTaxTotal;
...
@property (retain) NSArray *segmentPricing;  // of GTLQPXExpressSegmentPricing
