...
@implementation GTLQPXExpressSliceInfo
@dynamic duration, kind, segment;

+ (NSDictionary *)arrayPropertyToClassMap {
  NSDictionary *map =
    [NSDictionary dictionaryWithObject:[GTLQPXExpressSegmentInfo class]
                                forKey:@"segment"];
  return map;
}

+ (void)load {
  [self registerObjectClassForKind:@"qpxexpress#sliceInfo"];
}
