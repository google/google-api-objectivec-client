...
//
//  GTLQPXExpressFreeBaggageAllowance.m
//
...
@implementation GTLQPXExpressFreeBaggageAllowance
@dynamic bagDescriptor, kilos, kilosPerPiece, kind, pieces, pounds;

+ (NSDictionary *)arrayPropertyToClassMap {
  NSDictionary *map =
    [NSDictionary dictionaryWithObject:[GTLQPXExpressBagDescriptor class]
                                forKey:@"bagDescriptor"];
  return map;
}

+ (void)load {
  [self registerObjectClassForKind:@"qpxexpress#freeBaggageAllowance"];
}
