...
// Classes:
//   GTLAdSenseHostCustomChannel (0 custom class methods, 4 custom properties)

#import "GTLAdSenseHostCustomChannel.h"

// ----------------------------------------------------------------------------
//
//   GTLAdSenseHostCustomChannel
//

@implementation GTLAdSenseHostCustomChannel
...
+ (void)load {
  [self registerObjectClassForKind:@"adsensehost#customChannel"];
}
