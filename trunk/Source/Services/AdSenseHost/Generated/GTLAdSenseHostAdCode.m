...
// Classes:
//   GTLAdSenseHostAdCode (0 custom class methods, 2 custom properties)

#import "GTLAdSenseHostAdCode.h"

// ----------------------------------------------------------------------------
//
//   GTLAdSenseHostAdCode
//

@implementation GTLAdSenseHostAdCode
@dynamic adCode, kind;

+ (void)load {
  [self registerObjectClassForKind:@"adsensehost#adCode"];
}
