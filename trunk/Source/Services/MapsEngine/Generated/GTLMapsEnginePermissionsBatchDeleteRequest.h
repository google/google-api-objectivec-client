...
//
//  GTLMapsEnginePermissionsBatchDeleteRequest.h
//
...
// Classes:
//   GTLMapsEnginePermissionsBatchDeleteRequest (0 custom class methods, 1 custom properties)
...
@interface GTLMapsEnginePermissionsBatchDeleteRequest : GTLObject
