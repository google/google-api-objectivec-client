...
//
//  GTLAnalyticsEntityAdWordsLinks.h
//
...
@interface GTLAnalyticsEntityAdWordsLinks : GTLCollectionObject

// A list of entity AdWords links.
@property (nonatomic, retain) NSArray *items;  // of GTLAnalyticsEntityAdWordsLink
