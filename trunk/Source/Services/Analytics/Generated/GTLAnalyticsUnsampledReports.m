...
//
//  GTLAnalyticsUnsampledReports.m
//
...
@implementation GTLAnalyticsUnsampledReports
@dynamic items, itemsPerPage, kind, nextLink, previousLink, startIndex,
         totalResults, username;

+ (NSDictionary *)arrayPropertyToClassMap {
  NSDictionary *map =
    [NSDictionary dictionaryWithObject:[GTLAnalyticsUnsampledReport class]
                                forKey:@"items"];
  return map;
}

+ (void)load {
  [self registerObjectClassForKind:@"analytics#unsampledReports"];
}
