...
//
//  GTLAnalyticsProfileFilterLinks.h
//
...
@interface GTLAnalyticsProfileFilterLinks : GTLCollectionObject

// A list of profile filter links.
@property (nonatomic, retain) NSArray *items;  // of GTLAnalyticsProfileFilterLink
