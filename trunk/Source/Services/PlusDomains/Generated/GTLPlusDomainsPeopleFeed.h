...
// Classes:
//   GTLPlusDomainsPeopleFeed (0 custom class methods, 7 custom properties)
...
@class GTLPlusDomainsPerson;

// ----------------------------------------------------------------------------
//
//   GTLPlusDomainsPeopleFeed
//

// This class supports NSFastEnumeration over its "items" property. It also
// supports -itemAtIndex: to retrieve individual objects from "items".

@interface GTLPlusDomainsPeopleFeed : GTLCollectionObject
...
// people.get method.
@property (nonatomic, retain) NSArray *items;  // of GTLPlusDomainsPerson
