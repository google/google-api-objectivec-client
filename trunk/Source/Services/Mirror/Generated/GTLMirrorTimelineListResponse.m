...
//
//  GTLMirrorTimelineListResponse.m
//
...
@implementation GTLMirrorTimelineListResponse
@dynamic items, kind, nextPageToken;

+ (NSDictionary *)arrayPropertyToClassMap {
  NSDictionary *map =
    [NSDictionary dictionaryWithObject:[GTLMirrorTimelineItem class]
                                forKey:@"items"];
  return map;
}

+ (void)load {
  [self registerObjectClassForKind:@"mirror#timeline"];
}
