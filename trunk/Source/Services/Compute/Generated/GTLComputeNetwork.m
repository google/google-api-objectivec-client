...
@implementation GTLComputeNetwork
@dynamic creationTimestamp, descriptionProperty, gatewayIPv4, identifier,
         IPv4Range, kind, name, selfLink;
...
+ (void)load {
  [self registerObjectClassForKind:@"compute#network"];
}
