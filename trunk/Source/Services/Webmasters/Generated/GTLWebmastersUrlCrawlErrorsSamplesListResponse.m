...
//
//  GTLWebmastersUrlCrawlErrorsSamplesListResponse.m
//
...
@implementation GTLWebmastersUrlCrawlErrorsSamplesListResponse
@dynamic urlCrawlErrorSample;

+ (NSDictionary *)arrayPropertyToClassMap {
  NSDictionary *map =
    [NSDictionary dictionaryWithObject:[GTLWebmastersUrlCrawlErrorsSample class]
                                forKey:@"urlCrawlErrorSample"];
  return map;
}
