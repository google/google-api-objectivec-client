...
//
//  GTLAdExchangeSellerPreferredDeals.h
//
...
@class GTLAdExchangeSellerPreferredDeal;
...
@interface GTLAdExchangeSellerPreferredDeals : GTLCollectionObject

// The preferred deals returned in this list response.
@property (nonatomic, retain) NSArray *items;  // of GTLAdExchangeSellerPreferredDeal
