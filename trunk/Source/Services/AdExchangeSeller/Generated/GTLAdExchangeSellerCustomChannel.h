...
//
//  GTLAdExchangeSellerCustomChannel.h
//
...
// Classes:
//   GTLAdExchangeSellerCustomChannel (0 custom class methods, 5 custom properties)
//   GTLAdExchangeSellerCustomChannelTargetingInfo (0 custom class methods, 4 custom properties)
...
@class GTLAdExchangeSellerCustomChannelTargetingInfo;

// ----------------------------------------------------------------------------
//
//   GTLAdExchangeSellerCustomChannel
//

@interface GTLAdExchangeSellerCustomChannel : GTLObject
...
@property (nonatomic, retain) GTLAdExchangeSellerCustomChannelTargetingInfo *targetingInfo;
...
// ----------------------------------------------------------------------------
//
//   GTLAdExchangeSellerCustomChannelTargetingInfo
//

@interface GTLAdExchangeSellerCustomChannelTargetingInfo : GTLObject
