...
@implementation GTLAdExchangeSellerReport
...
+ (void)load {
  [self registerObjectClassForKind:@"adexchangeseller#report"];
}
...
@implementation GTLAdExchangeSellerReportHeadersItem
