...
//
//  GTLAdExchangeBuyerPerformanceReportList.m
//
...
@implementation GTLAdExchangeBuyerPerformanceReportList
@dynamic kind, performanceReport;

+ (NSDictionary *)arrayPropertyToClassMap {
  NSDictionary *map =
    [NSDictionary dictionaryWithObject:[GTLAdExchangeBuyerPerformanceReport class]
                                forKey:@"performanceReport"];
  return map;
}

+ (void)load {
  [self registerObjectClassForKind:@"adexchangebuyer#performanceReportList"];
}
