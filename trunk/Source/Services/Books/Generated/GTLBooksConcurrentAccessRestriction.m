...
//
//  GTLBooksConcurrentAccessRestriction.m
//
...
@implementation GTLBooksConcurrentAccessRestriction
...
+ (void)load {
  [self registerObjectClassForKind:@"books#concurrentAccessRestriction"];
}
