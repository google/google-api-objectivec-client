...
+ (NSArray *)checkClasses {
  NSArray *classes = [NSArray arrayWithObjects:
                      ...
                      [GTLYouTubeClientConfiguration class],
                      [GTLYouTubeClientConfigurationListResponse class],
                      [GTLYouTubeClientConfigurationSettings class],
                      [GTLYouTubeFeaturedChannel class],
                      [GTLYouTubeFeaturedVideo class],
                      ...
                      [GTLYouTubeInvideoFeature class],
                      ...
                      [GTLYouTubePlayer class],
                      [GTLYouTubePlayerAdsPlaylist class],
                      [GTLYouTubePlayerListResponse class],
                      [GTLYouTubePlayerRestrictionDetails class],
                      [GTLYouTubePlayerVideoUrl class],
                      [GTLYouTubePlayerVideoUrls class],
                      ...
                      [GTLYouTubePropertyValues class],
