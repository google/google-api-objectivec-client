...
//
//  GTLYouTubeCommentThreadSnippet.h
//
...
// Classes:
//   GTLYouTubeCommentThreadSnippet (0 custom class methods, 6 custom properties)
...
@interface GTLYouTubeCommentThreadSnippet : GTLObject
