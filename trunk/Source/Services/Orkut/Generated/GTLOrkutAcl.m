...
@implementation GTLOrkutAcl
@dynamic descriptionProperty, items, kind, totalParticipants;
...
+ (NSDictionary *)arrayPropertyToClassMap {
  NSDictionary *map =
    [NSDictionary dictionaryWithObject:[GTLOrkutAclItemsItem class]
                                forKey:@"items"];
  return map;
}

+ (void)load {
  [self registerObjectClassForKind:@"orkut#acl"];
}
...
@implementation GTLOrkutAclItemsItem
