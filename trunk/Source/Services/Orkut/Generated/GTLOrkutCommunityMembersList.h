...
//
//  GTLOrkutCommunityMembersList.h
//
...
@class GTLOrkutCommunityMembers;
...
@interface GTLOrkutCommunityMembersList : GTLCollectionObject
...
@property (retain) NSArray *items;  // of GTLOrkutCommunityMembers
