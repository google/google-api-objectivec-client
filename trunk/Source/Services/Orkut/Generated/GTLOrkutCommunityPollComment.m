...
//
//  GTLOrkutCommunityPollComment.m
//
...
@implementation GTLOrkutCommunityPollComment
@dynamic addedDate, author, body, identifier, kind;
...
+ (void)load {
  [self registerObjectClassForKind:@"orkut#communityPollComment"];
}
