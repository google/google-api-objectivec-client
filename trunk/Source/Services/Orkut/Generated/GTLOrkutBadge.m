...
@implementation GTLOrkutBadge
@dynamic badgeLargeLogo, badgeSmallLogo, caption, descriptionProperty,
         identifier, kind, sponsorLogo, sponsorName, sponsorUrl;
...
+ (void)load {
  [self registerObjectClassForKind:@"orkut#badge"];
}
