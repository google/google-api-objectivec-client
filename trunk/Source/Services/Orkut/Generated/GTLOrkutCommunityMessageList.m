...
//
//  GTLOrkutCommunityMessageList.m
//
...
@implementation GTLOrkutCommunityMessageList
@dynamic firstPageToken, items, kind, lastPageToken, nextPageToken,
         prevPageToken;

+ (NSDictionary *)arrayPropertyToClassMap {
  NSDictionary *map =
    [NSDictionary dictionaryWithObject:[GTLOrkutCommunityMessage class]
                                forKey:@"items"];
  return map;
}

+ (void)load {
  [self registerObjectClassForKind:@"orkut#communityMessageList"];
}
