...
@implementation GTLLatitudeLocation
@dynamic accuracy, activityId, altitude, altitudeAccuracy, heading, kind,
         latitude, longitude, speed, timestampMs;

+ (void)load {
  [self registerObjectClassForKind:@"latitude#location"];
}
