...
@interface EditACLWindowController : NSWindowController {
 @private
  IBOutlet NSComboBox *scopeTypeField_;
  IBOutlet NSTextField *scopeValueField_;
  IBOutlet NSComboBox *roleValueField_;

  void (^completionHandler_)(NSInteger returnCode, GTLCalendarAclRule *rule);

  GTLCalendarAclRule *rule_;
}
