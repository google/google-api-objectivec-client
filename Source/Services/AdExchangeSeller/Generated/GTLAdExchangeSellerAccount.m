...
// Classes:
//   GTLAdExchangeSellerAccount (0 custom class methods, 3 custom properties)

#import "GTLAdExchangeSellerAccount.h"

// ----------------------------------------------------------------------------
//
//   GTLAdExchangeSellerAccount
//

@implementation GTLAdExchangeSellerAccount
...
+ (void)load {
  [self registerObjectClassForKind:@"adexchangeseller#account"];
}
