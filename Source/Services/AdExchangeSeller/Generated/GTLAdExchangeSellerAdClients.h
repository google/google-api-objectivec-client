...
//
//  GTLAdExchangeSellerAdClients.h
//
...
@class GTLAdExchangeSellerAdClient;
...
@interface GTLAdExchangeSellerAdClients : GTLCollectionObject

// ETag of this response for caching purposes.
@property (nonatomic, copy) NSString *ETag;

// The ad clients returned in this list response.
@property (nonatomic, retain) NSArray *items;  // of GTLAdExchangeSellerAdClient
