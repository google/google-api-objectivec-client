...
//
//  GTLAdExchangeSellerUrlChannels.m
//
...
@implementation GTLAdExchangeSellerUrlChannels
...
+ (NSDictionary *)arrayPropertyToClassMap {
  NSDictionary *map =
    [NSDictionary dictionaryWithObject:[GTLAdExchangeSellerUrlChannel class]
                                forKey:@"items"];
  return map;
}

+ (void)load {
  [self registerObjectClassForKind:@"adexchangeseller#urlChannels"];
}
