...
//
//  GTLAdExchangeSellerCustomChannels.h
//
...
@class GTLAdExchangeSellerCustomChannel;
...
@interface GTLAdExchangeSellerCustomChannels : GTLCollectionObject

// ETag of this response for caching purposes.
@property (nonatomic, copy) NSString *ETag;

// The custom channels returned in this list response.
@property (nonatomic, retain) NSArray *items;  // of GTLAdExchangeSellerCustomChannel
