...
@implementation GTLAdSenseHostAdUnits
...
+ (NSDictionary *)arrayPropertyToClassMap {
  NSDictionary *map =
    [NSDictionary dictionaryWithObject:[GTLAdSenseHostAdUnit class]
                                forKey:@"items"];
  return map;
}

+ (void)load {
  [self registerObjectClassForKind:@"adsensehost#adUnits"];
}
