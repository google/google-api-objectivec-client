...
//
//  GTLDeploymentManagerManifestsListResponse.h
//
...
@class GTLDeploymentManagerManifest;
...
@interface GTLDeploymentManagerManifestsListResponse : GTLObject

// [Output Only] Manifests contained in this list response.
@property (nonatomic, retain) NSArray *manifests;  // of GTLDeploymentManagerManifest
