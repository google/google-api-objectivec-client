...
//
//  GTLDeploymentManagerResourcesListResponse.h
//
...
@class GTLDeploymentManagerResource;
...
@interface GTLDeploymentManagerResourcesListResponse : GTLObject

// A token used to continue a truncated list request.
@property (nonatomic, copy) NSString *nextPageToken;

// Resources contained in this list response.
@property (nonatomic, retain) NSArray *resources;  // of GTLDeploymentManagerResource
