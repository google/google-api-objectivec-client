...
// message parts.
@property (nonatomic, retain) GTLGmailMessagePartBody *body;
...
@property (nonatomic, retain) NSArray *headers;  // of GTLGmailMessagePartHeader
...
// see RFC 1521.
@property (nonatomic, retain) NSArray *parts;  // of GTLGmailMessagePart
