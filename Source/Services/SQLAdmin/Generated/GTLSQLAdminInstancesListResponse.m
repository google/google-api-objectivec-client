...
//
//  GTLSQLAdminInstancesListResponse.m
//
...
@implementation GTLSQLAdminInstancesListResponse
@dynamic items, kind, nextPageToken;

+ (NSDictionary *)arrayPropertyToClassMap {
  NSDictionary *map =
    [NSDictionary dictionaryWithObject:[GTLSQLAdminDatabaseInstance class]
                                forKey:@"items"];
  return map;
}

+ (void)load {
  [self registerObjectClassForKind:@"sql#instancesList"];
}
