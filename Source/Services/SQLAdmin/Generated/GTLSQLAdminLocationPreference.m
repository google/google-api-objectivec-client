...
//
//  GTLSQLAdminLocationPreference.m
//
...
@implementation GTLSQLAdminLocationPreference
@dynamic followGaeApplication, kind, zoneProperty;

+ (NSDictionary *)propertyToJSONKeyMap {
  NSDictionary *map =
    [NSDictionary dictionaryWithObject:@"zone"
                                forKey:@"zoneProperty"];
  return map;
}

+ (void)load {
  [self registerObjectClassForKind:@"sql#locationPreference"];
}
