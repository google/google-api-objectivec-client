...
@implementation GTLComputeFirewall
...
+ (NSDictionary *)arrayPropertyToClassMap {
  NSDictionary *map =
    [NSDictionary dictionaryWithObjectsAndKeys:
      [GTLComputeFirewallAllowedItem class], @"allowed",
      [NSString class], @"sourceRanges",
      [NSString class], @"sourceTags",
      [NSString class], @"targetTags",
      nil];
  return map;
}

+ (void)load {
  [self registerObjectClassForKind:@"compute#firewall"];
}
...
@implementation GTLComputeFirewallAllowedItem
