...
@implementation GTLComputeMetadata
@dynamic fingerprint, items, kind;

+ (NSDictionary *)arrayPropertyToClassMap {
  NSDictionary *map =
    [NSDictionary dictionaryWithObject:[GTLComputeMetadataItemsItem class]
                                forKey:@"items"];
  return map;
}

+ (void)load {
  [self registerObjectClassForKind:@"compute#metadata"];
}
...
@implementation GTLComputeMetadataItemsItem
@dynamic key, value;
@end
