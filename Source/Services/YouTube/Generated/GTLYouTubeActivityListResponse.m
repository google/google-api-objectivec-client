...
//
//  GTLYouTubeActivityListResponse.m
//
...
@implementation GTLYouTubeActivityListResponse
...
+ (NSDictionary *)arrayPropertyToClassMap {
  NSDictionary *map =
    [NSDictionary dictionaryWithObject:[GTLYouTubeActivity class]
                                forKey:@"items"];
  return map;
}

+ (void)load {
  [self registerObjectClassForKind:@"youtube#activityListResponse"];
}
