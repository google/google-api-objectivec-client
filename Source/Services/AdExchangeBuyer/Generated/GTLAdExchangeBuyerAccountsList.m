...
//
//  GTLAdExchangeBuyerAccountsList.m
//
...
@implementation GTLAdExchangeBuyerAccountsList
@dynamic items, kind;

+ (NSDictionary *)arrayPropertyToClassMap {
  NSDictionary *map =
    [NSDictionary dictionaryWithObject:[GTLAdExchangeBuyerAccount class]
                                forKey:@"items"];
  return map;
}

+ (void)load {
  [self registerObjectClassForKind:@"adexchangebuyer#accountsList"];
}
