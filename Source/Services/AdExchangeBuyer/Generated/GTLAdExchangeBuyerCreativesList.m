...
//
//  GTLAdExchangeBuyerCreativesList.m
//
...
@implementation GTLAdExchangeBuyerCreativesList
@dynamic items, kind, nextPageToken;

+ (NSDictionary *)arrayPropertyToClassMap {
  NSDictionary *map =
    [NSDictionary dictionaryWithObject:[GTLAdExchangeBuyerCreative class]
                                forKey:@"items"];
  return map;
}

+ (void)load {
  [self registerObjectClassForKind:@"adexchangebuyer#creativesList"];
}
