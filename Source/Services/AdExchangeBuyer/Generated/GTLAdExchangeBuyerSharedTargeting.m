...
//
//  GTLAdExchangeBuyerSharedTargeting.m
//
...
@implementation GTLAdExchangeBuyerSharedTargeting
@dynamic exclusions, inclusions, key;

+ (NSDictionary *)arrayPropertyToClassMap {
  NSDictionary *map = @{
    @"exclusions" : [GTLAdExchangeBuyerTargetingValue class],
    @"inclusions" : [GTLAdExchangeBuyerTargetingValue class]
  };
  return map;
}
