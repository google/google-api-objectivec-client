...
+ (NSArray *)checkClasses {
  NSArray *classes = @[
    ...
    [GTLAdExchangeBuyerDealServingMetadata class],
    ...
    [GTLAdExchangeBuyerDimension class],
    [GTLAdExchangeBuyerDimensionDimensionValue class],
    ...
    [GTLAdExchangeBuyerGetPublisherProfilesByAccountIdResponse class],
    ...
    [GTLAdExchangeBuyerProduct class],
    [GTLAdExchangeBuyerProposal class],
    [GTLAdExchangeBuyerPublisherProfileApiProto class],
    [GTLAdExchangeBuyerPublisherProvidedForecast class],
