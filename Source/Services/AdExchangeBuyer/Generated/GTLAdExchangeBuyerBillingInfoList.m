...
//
//  GTLAdExchangeBuyerBillingInfoList.m
//
...
@implementation GTLAdExchangeBuyerBillingInfoList
@dynamic items, kind;

+ (NSDictionary *)arrayPropertyToClassMap {
  NSDictionary *map =
    [NSDictionary dictionaryWithObject:[GTLAdExchangeBuyerBillingInfo class]
                                forKey:@"items"];
  return map;
}

+ (void)load {
  [self registerObjectClassForKind:@"adexchangebuyer#billingInfoList"];
}
