...
// Classes:
//   GTLMapsEngineFeature (0 custom class methods, 3 custom properties)
...
@class GTLMapsEngineGeoJsonGeometry;
@class GTLMapsEngineGeoJsonProperties;

// ----------------------------------------------------------------------------
//
//   GTLMapsEngineFeature
//
