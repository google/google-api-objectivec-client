...
//
//  GTLSpectrumPawsNotifySpectrumUseResponse.m
//
...
@implementation GTLSpectrumPawsNotifySpectrumUseResponse
@dynamic kind, type, version;

+ (void)load {
  [self registerObjectClassForKind:@"spectrum#pawsNotifySpectrumUseResponse"];
}
