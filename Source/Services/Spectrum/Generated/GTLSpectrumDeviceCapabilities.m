...
//
//  GTLSpectrumDeviceCapabilities.m
//
...
@implementation GTLSpectrumDeviceCapabilities
@dynamic frequencyRanges;

+ (NSDictionary *)arrayPropertyToClassMap {
  NSDictionary *map =
    [NSDictionary dictionaryWithObject:[GTLSpectrumFrequencyRange class]
                                forKey:@"frequencyRanges"];
  return map;
}
