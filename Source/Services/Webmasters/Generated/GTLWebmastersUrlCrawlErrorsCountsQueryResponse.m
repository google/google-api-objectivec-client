...
//
//  GTLWebmastersUrlCrawlErrorsCountsQueryResponse.m
//
...
@implementation GTLWebmastersUrlCrawlErrorsCountsQueryResponse
@dynamic countPerTypes;

+ (NSDictionary *)arrayPropertyToClassMap {
  NSDictionary *map =
    [NSDictionary dictionaryWithObject:[GTLWebmastersUrlCrawlErrorCountsPerType class]
                                forKey:@"countPerTypes"];
  return map;
}
