...
@implementation GTLOrkutCommunityTopic
@dynamic author, body, identifier, isClosed, kind, lastUpdate,
         latestMessageSnippet, links, messages, numberOfReplies, title;
...
+ (NSDictionary *)arrayPropertyToClassMap {
  NSDictionary *map =
    [NSDictionary dictionaryWithObjectsAndKeys:
      ...
      [GTLOrkutCommunityMessage class], @"messages",
      nil];
  return map;
}

+ (void)load {
  [self registerObjectClassForKind:@"orkut#communityTopic"];
}
