...
//
//  GTLOrkutCommunitypolloptionResource.m
//
...
@implementation GTLOrkutCommunitypolloptionResource
@dynamic descriptionProperty, image, numberOfVotes, optionId;
...
@implementation GTLOrkutCommunitypolloptionResourceImage
@dynamic url;
@end
