...
//
//  GTLOrkutCommunityPollCommentList.h
//
...
@interface GTLOrkutCommunityPollCommentList : GTLCollectionObject
...
@property (retain) NSArray *items;  // of GTLOrkutCommunityPollComment
