...
@implementation GTLOrkutCommunityMembers
@dynamic communityMembershipStatus, kind, person;

+ (void)load {
  [self registerObjectClassForKind:@"orkut#communityMembers"];
}
