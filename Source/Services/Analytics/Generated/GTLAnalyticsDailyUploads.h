...
// Classes:
//   GTLAnalyticsDailyUploads (0 custom class methods, 8 custom properties)
...
@class GTLAnalyticsDailyUpload;

// ----------------------------------------------------------------------------
//
//   GTLAnalyticsDailyUploads
//
...
@interface GTLAnalyticsDailyUploads : GTLCollectionObject

// A collection of daily uploads.
@property (retain) NSArray *items;  // of GTLAnalyticsDailyUpload
