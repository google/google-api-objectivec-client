...
//
//  GTLAnalyticsWebPropertySummary.m
//
...
+ (NSDictionary *)arrayPropertyToClassMap {
  NSDictionary *map =
    [NSDictionary dictionaryWithObject:[GTLAnalyticsProfileSummary class]
                                forKey:@"profiles"];
  return map;
}

+ (void)load {
  [self registerObjectClassForKind:@"analytics#webPropertySummary"];
}
