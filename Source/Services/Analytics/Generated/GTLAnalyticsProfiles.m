...
// Classes:
//   GTLAnalyticsProfiles (0 custom class methods, 8 custom properties)
...
@implementation GTLAnalyticsProfiles
...
+ (void)load {
  [self registerObjectClassForKind:@"analytics#profiles"];
}
